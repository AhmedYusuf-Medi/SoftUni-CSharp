...
namespace _04.MorsеCodeTranslator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var word in morse)
            {
                ...
                {
                    currentWord.Append(morseAlphabetDictionary[letter].ToString());
                }

                message.Add(currentWord.ToString());
            }

            Console.WriteLine(string.Join(" ", message).TrimEnd());
        }
    }
}
